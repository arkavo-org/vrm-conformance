...
- A **parametric VRM asset generator** that emits a deterministic test corpus. v0.1: full MToon material parameter sweep + single-chain VRMC_springBone parameter sweep (joint count, stiffness, drag, gravity, segment length — all validator-clean). Constraints + expressions land in later phases.
